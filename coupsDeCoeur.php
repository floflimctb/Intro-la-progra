            ...
            <?php include('banniere.inc.html'); ?>
       		...
       		<section>
                <div style="display: block;">
                    ...
                    <article>
                        <h2>Un classique : Fullmetal Alchemist</h2>

                        <p>
                            <a href="https://www.youtube.com/watch?v=2uq34TeWEdQ" target="_blank"><img src="images/fullmetal.jpg" alt="Fullmetal Alchemist" id="fullmetal" height=300 weight=300 /></a>
                        </p>
                        <p>
                            Notre coup de coeur absolu, parmis les milliers d'anime qu'on a pu voir, c'est celui-ci qui s'est démarqué haut la main ! Bravo à l'auteur, et à toute l'équipe !
                        </p>
